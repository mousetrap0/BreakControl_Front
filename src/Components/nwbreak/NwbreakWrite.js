...
function NwBreakWrite() {
	...
	const createNwBreak = async() => {
		...
		await axios.post("http://localhost:3000/nwbreak", req, {headers: headers})
		.then((resp) => {
	...
	return (
		<div>
			...
			<div className="my-5 d-flex justify-content-center">
				<button className="btn btn-outline-secondary" onClick={createNwBreak}><i className="fas fa-pen"></i> 등록하기</button>
			</div>
		</div>
	);
}
